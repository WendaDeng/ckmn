...
class ActivityNet(data.Dataset):
    ...
    def __init__(self,
                 ...
                 annotation_path,
                 subset,
                 sceobj_spatial_transform=None,
                 action_spatial_transform=None,
                 temporal_transform=None,
                 get_loader=get_default_video_loader):
        self.data = make_dataset(root_path, annotation_path, subset)

        self.sceobj_spatial_transform = sceobj_spatial_transform
        self.action_spatial_transform = action_spatial_transform
    ...
    def __getitem__(self, index):
        ...
        return path, target, frame_indices
