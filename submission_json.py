...
def main(args):
    ...
    for test_set in ['seen', 'unseen']:
        if test_set == 'unseen':
            training_labels = pd.read_pickle(os.path.join(args.annotation_path, 'EPIC_full_train_action_labels.pkl'))
        ...
        if test_set == 'seen':
            timestamps = pd.read_pickle(os.path.join(args.annotation_path, 'EPIC_test_s1_timestamps.pkl'))
        else:
            timestamps = pd.read_pickle(os.path.join(args.annotation_path, 'EPIC_test_s2_timestamps.pkl'))
